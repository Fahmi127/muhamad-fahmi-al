...
function addTask(taskText =null, completed =false, taskColor = null, taskCategory =null, save = true) {
    ...
    checkbox.addEventListener("change", function () {
        ...
        saveTasks();
        updateCounter();
        filterTask(); // Perbarui tampilan setelah mengubah status
    });

    // Edit Tugas
    li.querySelector(".edit-bn").addEventListener("click", function () {
    ...
    // Hapus Tugas
    li.querySelector(".delete-bn").addEventListener("click", function () {
    ...
    filterTask(); // Pastikan filter tetap berlaku setelah menambah tugas
}
...
function updateCounter() {
    ...
    const completedCounter = document.querySelectorAll(".task-item.completed").length;
